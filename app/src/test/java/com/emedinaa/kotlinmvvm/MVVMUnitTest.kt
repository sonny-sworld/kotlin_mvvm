...
import com.emedinaa.kotlinmvvm.model.MuseumDataSourceInterface
...
class MVVMUnitTest {
    ...
    @Mock
    private lateinit var museumDataSource: DataSourceInterface
    ...
    fun setup() {
        ...
        repository = Repository(museumDataSource)
    ...
    fun `retrieve museums with ViewModel and Repository returns empty data`() {
        ...
        verify(museumDataSource, times(1)).retrieveRemoteData(capture(operationCallbackCaptor))
